                            ...
                            <div className="h-[60px] flex justify-start gap-2 items-center text-white px-2 py-2
                                ...
                                <div className="flex justify-center items-start flex-col w-full">
                                    <div className="flex justify-between items-center w-full">
                                        <h2 className="text-base font-semibold">Herval Mata</h2>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="flex justify-between items-center">
                            {
                                ...
                                <div className="flex justify-start items-center gap-3">
                                    ...
                                    <h2 className='text-base text-white font-semibold'>Herval</h2>
                                </div>
                            }
                            <div className='w-[35px] flex md:hidden h-[35px] rounded-sm bg-blue-500 shadow-lg
                                                   hover:shadow-blue-500/50 justify-center cursor-pointer
                                ...
                                <div className='w-full flex justify-start items-center'>
                                    <div className="flex justify-start items-start gap-2 md:px-3 py-2 max-w-full
                                        ...
                                        <div className="flex justify-center items-start flex-col w-full
                                                                bg-blue-500 shadow-lg shadow-blue-500/50 text-white
                                                                py-1 px-2 rounded-sm">
                                            <span>Eu preciso de alguma ajuda</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
