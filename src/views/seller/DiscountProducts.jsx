...
const DiscountProducts = () => {
    ...
    return (
        <div className="px-2 lg-px-7 pt-5">
            <h1 className="text-[#D0D2D6] font-semibold text-lg mb-3">Descontos dos Produtos</h1>
                        ...
                        <tbody>
                        {
                            [1,2,3,4,5].map((d,i) =>
                                <tr key={i}>
                                    ...
                                    <td className='py-1 px-4 font-medium whitespace-nowrap'>Laço Nº1</td>
                                    <td className='py-1 px-4 font-medium whitespace-nowrap'>Laços</td>
