    ...
    return (
        <div>
            <div onClick={() => setShowSidebar(false)} className={`fixed duration-200 ${!showSidebar ? 
                'invisible' : 'visible'} w-screen h-screen bg-[#8CBCE780] top-0 left-0 z-10`}></div>
            <div className={`w-[260px] fixed bg-[#E6E7FB] z-50 top-0 h-screen shadow-[0_0_15px_0_rgb(34_41_47_/_5%)] 
